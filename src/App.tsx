...
/** Convert px design value to rem (base 16px) */
...
function isLightTheme(bg: string): boolean {
  ...
  return (rv * 299 + g * 587 + b * 114) / 1000 > 128
}
  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        padding: `${r(10)} ${r(16)}`, borderBottom: `1px solid ${tc.editorBorder}`,
        background: tc.headerBg, flexShrink: 0, gap: r(12),
      }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: r(10) }}>
          <svg width={r(22)} height={r(22)} viewBox="0 0 24 24" fill="none" stroke={tc.accent} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
            <polygon points="12 2 22 8.5 22 15.5 12 22 2 15.5 2 8.5 12 2" />
            <line x1="12" y1="22" x2="12" y2="15.5" />
            <polyline points="22 8.5 12 15.5 2 8.5" />
          </svg>
          <span style={{ fontWeight: 700, fontSize: r(14), color: tc.uiFgActive, letterSpacing: '-0.02em' }}>
            Mermaid Editor
          </span>
          <span style={{ fontSize: r(11), color: tc.uiFg, opacity: 0.6, marginLeft: r(2) }}>
            beautiful-mermaid
          </span>
        </div>
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: r(8) }}>
          {mode === 'svg' && (
            <button
              ...
              style={{
                ...
                color: transparent ? '#fff' : tc.uiFg, fontSize: r(10),
                cursor: 'pointer', padding: `${r(4)} ${r(10)}`, borderRadius: r(6),
          ...
          <div style={{ position: 'relative' }}>
            <button
              ...
              style={{
                display: 'flex', alignItems: 'center', gap: r(6),
                background: tc.isDark ? '#1e1e28' : '#eee',
                border: `1px solid ${tc.editorBorder}`, color: tc.uiFgActive,
                fontSize: r(11), cursor: 'pointer', padding: `${r(5)} ${r(10)}`,
                borderRadius: r(6), fontFamily: 'inherit',
              }}
            >
              <span style={{
                width: r(10), height: r(10), borderRadius: '50%', flexShrink: 0,
                background: `linear-gradient(135deg, ${tc.bg} 50%, ${tc.accent} 50%)`,
                border: `1px solid ${tc.editorBorder}`,
              }} />
              {theme}
              <svg width={r(10)} height={r(10)} viewBox="0 0 10 10" fill="none" stroke={tc.uiFg} strokeWidth="1.5">
            ...
            {showThemes && (
              <div style={{
                position: 'absolute', top: `calc(100% + ${r(6)})`, right: 0,
                background: tc.isDark ? '#1a1a24' : '#fff',
                border: `1px solid ${tc.editorBorder}`, borderRadius: r(8),
                padding: r(6), zIndex: 100, width: r(240), maxHeight: r(360), overflowY: 'auto',
                  ...
                  return (
                    <button
                      ...
                      style={{
                        ...
                        width: '100%', padding: `${r(7)} ${r(10)}`, border: 'none', borderRadius: r(5),
                        background: name === theme ? (tc.isDark ? '#2a2a3a' : '#e8e8f0') : 'transparent',
                        color: name === theme ? tc.uiFgActive : tc.uiFg,
                        fontSize: r(11), cursor: 'pointer', fontFamily: 'inherit', textAlign: 'left',
                      }}
                    >
                      <span style={{
                        width: r(14), height: r(14), borderRadius: r(4), flexShrink: 0,
                        background: `linear-gradient(135deg, ${th.bg} 50%, ${thAccent} 50%)`,
                        border: `1px solid ${tc.isDark ? '#333' : '#ddd'}`,
                      }} />
                      {name}
                      <span style={{ marginLeft: 'auto', fontSize: r(9), opacity: 0.5 }}>
                        {thIsDark ? 'dark' : 'light'}
                      </span>
                    </button>
                  )
      ...
      <div ref={containerRef} style={{ display: 'flex', flex: 1, overflow: 'hidden' }}>
        ...
        <div style={{
          ...
          <div style={{
            padding: `${r(8)} ${r(14)}`, fontSize: r(10), color: tc.uiFg,
        ...
        <div
          ...
          style={{
            width: r(3), cursor: 'col-resize', flexShrink: 0,
        ...
        <div style={{ flex: 1, display: 'flex', flexDirection: 'column', overflow: 'hidden' }}>
          <div style={{
            display: 'flex', alignItems: 'center', justifyContent: 'space-between',
            padding: `${r(6)} ${r(14)}`, borderBottom: `1px solid ${tc.editorBorder}`,
            ...
            <div style={{ display: 'flex', gap: 0 }}>
              {(['svg', 'unicode', 'ascii'] as OutputMode[]).map(m => (
                <button
                  ...
                  onClick={() => setMode(m)}
                  style={{
                    background: 'none', border: 'none', fontSize: r(10),
                    textTransform: 'uppercase', letterSpacing: '0.08em',
                    color: mode === m ? tc.uiFgActive : tc.uiFg,
                    cursor: 'pointer', padding: `${r(4)} ${r(10)}`,
            ...
            <div style={{ display: 'flex', gap: r(6) }}>
              <button
                onClick={copyOutput}
                disabled={!output}
                style={{
                  background: 'none', border: `1px solid ${tc.editorBorder}`,
                  color: tc.uiFg, fontSize: r(10), cursor: output ? 'pointer' : 'default',
                  padding: `${r(3)} ${r(8)}`, borderRadius: r(4), fontFamily: 'inherit',
              ...
              <button
                ...
                disabled={!output}
                style={{
                  background: tc.accent, border: 'none', color: '#fff', fontSize: r(10),
                  cursor: output ? 'pointer' : 'default', padding: `${r(3)} ${r(10)}`,
                  borderRadius: r(4), fontFamily: 'inherit', fontWeight: 600,
                  opacity: output ? 1 : 0.4,
                }}
              >
                Download
          ...
          <div style={{
            ...
            {error ? (
              <div style={{
                color: '#f87171', fontSize: r(12), maxWidth: r(400), textAlign: 'center',
                lineHeight: 1.6, padding: r(20),
                background: tc.isDark ? 'rgba(248,113,113,0.06)' : 'rgba(248,113,113,0.08)',
                borderRadius: r(8), border: '1px solid rgba(248,113,113,0.15)',
              }}>
                <div style={{ fontWeight: 600, marginBottom: r(6) }}>Parse Error</div>
      ...
      <div style={{
        display: 'flex', alignItems: 'center', justifyContent: 'space-between',
        padding: `${r(6)} ${r(14)}`, borderTop: `1px solid ${tc.editorBorder}`,
        background: tc.headerBg, fontSize: r(10), color: tc.uiFg, flexShrink: 0,
      }}>
        <span>
          <span style={{
            display: 'inline-block', width: r(6), height: r(6), borderRadius: '50%',
            marginRight: r(6), verticalAlign: 'middle',
